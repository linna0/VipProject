        ...
        <div class="content container-fluid card m-t-50 "><!-- Page Header -->
            <div class="page-header card-header ">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">增加VIP</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/vip/allvip">返回主页面</a></li>
                            <li class="breadcrumb-item active">增加vip</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <form action="${pageContext.request.contextPath}/vip/AddVip" method="post">
                    ...
                    <label  for="vipId" class="col-sm-2 col-form-label col-2" style="font-size:26px;padding-left:40px;">会员账号:</label>
                        <div class="col-sm-7 col-7">
                            <input type="text" name="vipId" class="form-control"  id="vipId" placeholder="请输入会员账号">
                        </div>
                    ...
                    <label  for="vipName" class="col-sm-2 col-form-label col-2" style="font-size:26px;padding-left:40px;">会员名：</label>
                        <div class="col-sm-7 col-7">
                        <input type="text" name="vipName" class=" form-control" id="vipName"  placeholder="请输入会员名字"></div>
                        <div class="col-sm-2 col-2">
                    ...
                    <label for="vipNumber"class="col-sm-2 col-form-label col-2" style="font-size:26px;padding-left:35px;">电话号码：</label>
                        <div class="col-sm-7 col-7">
                            <input type="text" name="vipNumber" class=" form-control" id="vipNumber" placeholder="请输入会员号码"></div>  <div class="col-sm-2 col-2">
                    ...
                    <label class="col-sm-2 col-form-label col-2" style="font-size:26px;padding-left:40px;" for="vipBalance">余额：</label>
                                    <div class="col-sm-7 col-7">
                                    <input type="text" name="vipBalance"  class=" form-control" id="vipBalance"  placeholder="请输入充值金额"></div>
                                    <div class="col-sm-2 col-2">
                    ...
                    <input type="submit" value="添加" class="btn btn-primary" style="width:400px;margin-right: 50px;">
                    <input type="reset" value="重置" class="btn btn-primary" style="width:400px;">
                </form>
